...
`docker run -d -p 6378:6379 --name redisg-replica -v redis-ro:/data redislabs/redisgraph:2.8.13 --loadmodule /usr/lib/redis/modules/redisgraph.so --replicaof 172.17.0.1 6379`
